    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (!login.isEmpty() && !password.isEmpty()) {
                User users = clientws.verifyUser(login, password);
                if (users != null) {
                    this.dispose();
                    new Principal(login).setVisible(true);
                } else {
                    txtmessage.setVisible(true);
                    txtmessage.setText("Votre login ou password incorrect");
                }
            } else {
                txtmessage.setVisible(true);
                txtmessage.setText("Veuillez entrez votre login et password");
            }
        } catch (Exception e) {
